...
{
    public class StoreItemQuantityRepo : GenaricRepository<StoreItemQuantity> , IStoreItemQuantityRepo
    {
        public StoreItemQuantityRepo(SmartStoreContext smartStore) : base(smartStore)  
        {
